        ...
        <div className="space-y-6">
          <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-xs space-y-4">
            <div className="flex items-center gap-2.5">
              ...
              <h3 className="text-base font-extrabold text-slate-900">Trạng thái Cơ sở Dữ liệu & Lưu trữ</h3>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
              <div className="p-4 rounded-xl bg-slate-50 border border-slate-200 space-y-1">
                <p className="font-bold text-slate-700">Chế độ hoạt động hiện tại:</p>
                <p className="text-emerald-700 font-semibold flex items-center gap-1.5">
                  <span className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse" />
                  {isFirebaseConfigured ? 'Firebase Cloud Firestore' : 'LocalStorage Spark Ready (Offline-First)'}
                </p>
                <p className="text-slate-500">Độ trễ phản hồi tức thì, bảo đảm làm bài thi không bị ngắt quãng.</p>
              </div>

              <div className="p-4 rounded-xl bg-slate-50 border border-slate-200 space-y-1">
                <p className="font-bold text-slate-700">Phiên bản Ngân hàng Đề:</p>
                <p className="text-purple-700 font-semibold font-mono">v4_full_solutions (21 Chuyên đề - 992 câu)</p>
                <p className="text-slate-500">Tích hợp đầy đủ đáp án chuẩn và lời giải KaTeX từng bước.</p>
              </div>
            </div>
          </div>
